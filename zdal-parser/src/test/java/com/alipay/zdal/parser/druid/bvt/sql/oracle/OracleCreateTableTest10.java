 ...
 * @version $Id: OracleCreateTableTest10.java, v 0.1 2012-5-17 上午10:15:51 xiaoqing.zhouxq Exp $
 */
public class OracleCreateTableTest10 extends OracleTest {
    ...
    public void test_0() throws Exception {
        ...
        Assert.assertTrue(visitor.getTables().containsKey(
            new TableStat.Name("sys.ora_temp_1_ds_16247")));
        Assert.assertTrue(visitor.getTables().containsKey(
            new TableStat.Name("SYS.WRI$_OPTSTAT_HISTHEAD_HISTORY")));

        Assert.assertEquals(21, visitor.getColumns().size());

        Assert.assertTrue(visitor.getColumns().contains(
            new TableStat.Column("SYS.WRI$_OPTSTAT_HISTHEAD_HISTORY", "OBJ#")));
