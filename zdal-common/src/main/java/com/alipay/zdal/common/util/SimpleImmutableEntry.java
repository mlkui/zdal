 ...
 * @since 1.6
 */
public class SimpleImmutableEntry<K, V> implements Entry<K, V>, java.io.Serializable {
     ...
     * e1.hashCode()==e2.hashCode()} for any two Entries {@code e1} and {@code
     * e2}, as required by the general contract of {@link Object#hashCode}.
     * 
