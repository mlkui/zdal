...
import com.alipay.zdal.common.exception.runtime.InputStringIsNotValidException;
...
public class StringUtil {
    ...
    public static String replaceIgnoreCase(String s, String oldPattern, String newPattern) {
        return Pattern.compile(oldPattern, Pattern.CASE_INSENSITIVE).matcher(s).replaceAll(
            newPattern);
    }
